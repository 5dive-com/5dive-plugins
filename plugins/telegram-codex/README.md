...
- v0.2.0 — configurable knobs in `access.json`: `ackReaction` (emoji on every inbound, off by default), `textChunkLimit` (override the 4000-char chunker cap, range 500–4096), `dmPolicy` (allowlist/static — reserved for forward parity). (this)
