...
// DIVE-3910: the autonomous-silence notice was REMOVED here (lodar, 2026-09-02:
// "I feel this works wrongly ... I never seen its been useful ... it just confuses
// clients"). It fell back to a human's DM whenever no group topic was configured,
// which is every seat here, so the one shape its own comment called a nag was the
// only shape it ever took. The agent-side silence-watchdog is untouched.
